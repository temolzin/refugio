                                    ...
                                    <div class="col-lg-8">
                                        <div class="form-group text-center">
                                            ...
                                            <div class="image-preview-container" style="display: flex; justify-content: center; margin-bottom: 10px;">
                                                ...
                                                <img id="logo-preview-edit-{{ $shelters->id }}" src="{{ $shelters->getFirstMediaUrl('logos') }}" alt="Logo Actual" style="width: 120px; height: 120px; border-radius: 50%; margin-bottom: 20px;">
                                                @else
