<div class="modal fade" id="edit{{$shelters->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
                ...
                <div class="row">
                  <div class="col-lg-12 d-flex justify-content-center align-items-center">
                    <div class="form-group text-center">
                      @if($shelters->getFirstMediaUrl('logos'))
                          <img src="{{ $shelters->getFirstMediaUrl('logos') }}" alt="Logo Actual"
                    ...
                    @endif
                      ...
                      <input type="file" class="form-control @error('logo') is-invalid @enderror" name="logo" id="logo"
                        aria-describedby="helpId" placeholder="" value="{{$shelters->logo}}"
                          ...
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <select class="form-control @error('user_id') is-invalid @enderror" name="user_id"
                                id="user_id" required style="height: 43px;">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                id="name" aria-describedby="helpId" placeholder="" value="{{$shelters->name}}"
                                required />
                              @error('name')
                              <span class="invalid-feedback">
                              <strong>{{$message}}</strong>
                          ...
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone"
                                id="phone" aria-describedby="helpId" placeholder="" value="{{ $shelters->phone }}"
                                required />
                              @error('phone')
                              <span class="invalid-feedback">
                              <strong>{{ $message }}</strong>
                          ...
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control @error('facebook') is-invalid @enderror"
                                name="facebook" id="facebook" aria-describedby="helpId" placeholder=""
                                value="{{ $shelters->facebook }}" required />
                              @error('facebook')
                              <span class="invalid-feedback">
                              <strong>{{ $message }}</strong>
                              </span>
                              ...
                              <div class="col-lg-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control @error('tiktok') is-invalid @enderror"
                                    name="tiktok" id="tiktok" aria-describedby="helpId" placeholder=""
                                    value="{{ $shelters->tiktok }}" required />
                                  @error('tiktok')
                                <span class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                                </span>
                                    ...
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('state') is-invalid @enderror" name="state"
                                          id="state" aria-describedby="helpId" placeholder="" value="{{ $shelters->state }}"
                                          required />
                                          @error('state')
                                          <span class="invalid-feedback">
                                          <strong>{{ $message }}</strong>
                                        ...
                                        @enderror
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('city') is-invalid @enderror" name="city"
                                              id="city" aria-describedby="helpId" placeholder="" value="{{ $shelters->city }}"
                                              required />
                                            @error('city')
                                            <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-lg-6">
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('address') is-invalid @enderror"
                                              ...
                                              value="{{ $shelters->address }}" required />
                                            @error('address')
                                              <span class="invalid-feedback">
                                              <strong>{{ $message }}</strong>
                                              </span>
                                        ...
                                        <div class="col-lg-6">
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('postal_code') is-invalid @enderror"
                                              name="postal_code" id="postal_code" aria-describedby="helpId" placeholder=""
                                              value="{{ $shelters->postal_code }}" required />
                                            @error('postal_code')
                                <span class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                                </span>
